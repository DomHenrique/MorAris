...
env_vars = [
    ...
    {"name":"ALLOWED_HOSTS","value":"morAris.griddmkt360.com.br, www.morAris.griddmkt360.com.br, localhost, 127.0.0.1"},
...
req = urllib.request.Request(
    'https://portainer.griddmkt360.com.br/api/stacks/create/standalone/string?endpointId=3',
